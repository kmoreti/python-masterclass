...
if __name__ == "__main__":
    print(timeit.timeit("x = fact(130)", setup="from __main__ import fact", number=100000))
    print(timeit.timeit("x = factorial(130)", setup="from __main__ import factorial", number=100000))

    list1 = timeit.repeat("x = fact(130)", setup="from __main__ import fact", number=100000, repeat=6)
    list2 = timeit.repeat("x = factorial(130)", setup="from __main__ import factorial", number=100000, repeat=6)
