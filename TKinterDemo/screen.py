...
main_window.geometry('640x480+100+200')
main_window['padx'] = 8
...
file_list.config(border=1, relief='sunken')
...
# Buttons
ok_button = tkinter.Button(main_window, text="OK", width=7)
cancel_button = tkinter.Button(main_window, text="Cancel", command=main_window.quit, width=7)
